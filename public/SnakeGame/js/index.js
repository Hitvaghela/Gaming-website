...
if (username) {
    // Select the element with class 'button1' and set its text content to the username
...
async function store() {
    try {
        ...
        const response = await fetch("/store_recorde", {
            ...
            body: JSON.stringify({ username: username, score: data1,game:'snakegame' }) // Convert JSON object to string
        });
